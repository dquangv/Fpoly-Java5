        ...
        <body>
            ...
            <div class="form-container">
                <form action="${pageContext.request.contextPath}/books/saveOrUpdate" method="post">
                    ...
                    <div class="form-label">Title:</div>
                    <input type="text" name="title" value="${book.title}" class="form-input">
                    <c:if test="${not empty errorMessages['title']}">
                        <span style="color: red;">${errorMessages['title']}</span>
                    </c:if>
                    <br>
            
                    <div class="form-label">Author:</div>
                    <input type="text" name="author" value="${book.author}" class="form-input">
                    <c:if test="${not empty errorMessages['author']}">
                        <span style="color: red;">${errorMessages['author']}</span>
                    </c:if>
                    <br>
            
                    <div class="form-label">Price:</div>
                    <input type="number" name="price" value="${book.price}" class="form-input">
                    <c:if test="${not empty errorMessages['price']}">
                        <span style="color: red;">${errorMessages['price']}</span>
                    </c:if>
                    <br>
            
                    <div class="form-label">Time Published:</div>
                    <input type="datetime-local" name="timePublished" value="${book.timePublished}" class="form-input">
                    <c:if test="${not empty errorMessages['timePublished']}">
                        <span style="color: red;">${errorMessages['timePublished']}</span>
                    </c:if>
                    <br>
                    ...
                    <div style="display: flex; align-items: center;">
                        ...
                        <button type="submit" name="action" value="reset" class="btn btn-secondary" formaction="${pageContext.request.contextPath}/books/reset">Reset</button>
            ...
            <table>
                ...
                <c:forEach items="${bookList}" var="book">
                    <tr>
                        ...
                        <td>${book.author}</td>
                        <td>${book.price}</td>
                        <td>${book.formattedTimePublished}</td>
                        <td>${book.genre}</td>
                        <td>
